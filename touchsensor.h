...
public:
        ...
        virtual ProcessElement startElement(const std::string& name, const AttributesList& atts)
        {
            ...
            static boost::array<string, 5> tags = { { "sensor", "scantime", "color", "time_scan"}};
...
.. image:: ../../../images/interface_baselaser.jpg\n\
  :width: 400\n\
";
        RegisterCommand("render",boost::bind(&TouchSensor::_Render,this,_1,_2),
        ...
        _pgeom->min_angle[0] = -PI/16; _pgeom->min_angle[1] = 0;
        _pgeom->max_angle[0] = PI/16; _pgeom->max_angle[1] = 0;
        _pgeom->resolution[0] = 0.01f; _pgeom->resolution[1] = 0;
        _pgeom->min_range = 0.03;
        _pgeom->max_range = 0.5;
        _fTimeToScan = 0;
    ...
    virtual bool SimulationStep(dReal fTimeElapsed)
    {
        ...
        if( _bPower &&( _fTimeToScan <= 0) ) {
            ...
            int TOUCH = (int) _pdata->touch.size();
            _pdata->touch[1] = 0;
            ...
            //_pdata->touch[1] = 1;
            std::cout << "Touch Sensor :"<< _pdata->touch[1] << std::endl;
